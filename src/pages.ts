...
export function recording(env: Env) {
  return page(
    ...
    '<script src="/transcription.js?v=20260922-publish-errors" defer></script>',
    "/record.js",
    true,
  );
}
