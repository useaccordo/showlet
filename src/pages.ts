...
export function recording(env: Env) {
  return page(
    ...
    '<script src="/transcription.js?v=20260911-play-overlay" defer></script>',
    "/record.js",
    true,
  );
}
